    ...
    <>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <FadeIn>
            ...
            <h1 className="font-display text-5xl sm:text-7xl lg:text-8xl text-[#F0ECE4] leading-none mb-6">
              1-ON-1 MENTAL PERFORMANCE COACHING BUILT AROUND YOUR <span className="text-[#C8F04A]">ATHLETE.</span>
            </h1>
      ...
      <section className="bg-[#1A1A2E] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-2 border-[#C8F04A] rounded-sm overflow-hidden shadow-[0_0_60px_rgba(200,240,74,0.10)]">
            <div className="p-8 lg:p-12 bg-[#C8F04A]/5">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                {/* Left: price + description + for who */}
                <FadeIn>
                  <div>
                    <p className="font-display text-6xl lg:text-7xl text-[#C8F04A] mb-1">{coreOffer.price}</p>
                    <p className="text-[#555566] text-xs uppercase tracking-[0.15em] mb-8">{coreOffer.priceNote}</p>
                ...
                <FadeIn delay={0.1}>
                  <div>
                    <p className="text-[#555566] text-xs uppercase tracking-[0.18em] mb-5 font-semibold">
                      What&apos;s Included
                    </p>
                    <ul className="space-y-4 mb-8">
                      {coreOffer.features.map((f) => (
                        <li key={f} className="flex items-start gap-3 text-sm">
                          <Check size={16} className="text-[#C8F04A] mt-0.5 shrink-0" />
      ...
      <section className="bg-[#0D0D1A] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <FadeIn className="mb-12">
            ...
            <p className="text-[#555566] text-base max-w-xl">
          ...
          {/* Monthly add-ons */}
          <div className="mb-10">
            <p className="text-[#555566] text-xs uppercase tracking-[0.18em] mb-5 font-semibold flex items-center gap-3">
              Monthly Add-Ons
      ...
      <section className="bg-[#1A1A2E] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <FadeIn className="mb-10">
            ...
            <p className="text-[#555566] text-base">
          ...
          <FadeIn delay={0.08}>
            <div className="border border-[#1E1E30] rounded-sm overflow-hidden">
              {pricingExamples.map((example, i) => (
                <div
                  key={example.label}
                  className={`flex items-center justify-between px-6 py-5 ${
                    i < pricingExamples.length - 1 ? 'border-b border-[#1E1E30]' : ''
                  } ${i % 2 === 0 ? 'bg-[#12121F]' : 'bg-[#12121F]/50'}`}
                >
                  <p className="text-[#F0ECE4]/80 text-sm">{example.label}</p>
                  <p className="font-display text-2xl text-[#C8F04A]">{example.price}</p>
                </div>
              ))}
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.12}>
            <p className="text-[#555566] text-xs text-center mt-4">
