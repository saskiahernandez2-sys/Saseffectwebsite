          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <FadeIn delay={0.05}>
              <div className="bg-[#111111] border border-[#2a2a2a] rounded-sm p-7">
                ...
                <p className="text-[#666666] text-xs mb-5 leading-relaxed">{foundation.topicsNote}</p>
                <ul className="space-y-2">
                  {foundation.topics.map((topic) => (
                    <li key={topic} className="flex items-center gap-3 text-sm">
                      ...
                      <span className="text-[#F0ECE4]/80">{topic}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <FadeIn delay={0.1}>
              <div className="bg-[#0a0a0a] border border-[#C0392B]/50 rounded-sm p-7">
                ...
                <p className="text-[#666666] text-xs mb-5 leading-relaxed">{effect.topicsNote}</p>
                <ul className="space-y-2">
